...
{
    internal class AveragingSellService : IAveragingSellService
    {
        ...
        public AveragingSellService(ILogger<AveragingSellService> logger, IBalanceProvider balances, ISavingsProvider savings, ITickerProvider tickers, IEnsureSingleOrderService ensureSingleOrderBlock, IClearOpenOrdersService clearOpenOrdersBlock)
        {
            _logger = logger;
            _balances = balances;
            _savings = savings;
        ...
        private static string TypeName => nameof(AveragingSellService);
