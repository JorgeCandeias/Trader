...
internal partial class AveragingSellExecutor : IAlgoCommandExecutor<AveragingSellCommand>
{
    ...
    public ValueTask ExecuteAsync(IAlgoContext context, AveragingSellCommand command, CancellationToken cancellationToken = default)
    {
        ...
        return new EnsureSingleOrderCommand(command.Symbol, OrderSide.Sell, OrderType.Limit, TimeInForce.GoodTillCanceled, desired.Quantity, null, desired.Price, null, null, command.RedeemSavings, command.RedeemSwapPool)
