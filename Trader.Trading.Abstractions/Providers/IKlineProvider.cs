...
namespace Outcompute.Trader.Trading.Providers
{
    public interface IKlineProvider
    {
        ...
        /// </summary>
        ValueTask<IReadOnlyList<Kline>> GetKlinesAsync(string symbol, KlineInterval interval, DateTime start, DateTime end, CancellationToken cancellationToken = default);
    }
}