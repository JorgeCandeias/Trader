...
{
    internal const int DefaultFastPeriods = 7;
    internal const int DefaultMediumPeriods = 14;
    internal const int DefaultSlowPeriods = 28;
...
public static partial class Indicator
{
    ...
    public static IEnumerable<decimal?> ToUltimateOscillator(
        ...
        int mediumPeriods = Indicators.UltimateOscillator.DefaultMediumPeriods,
        int slowPeriods = Indicators.UltimateOscillator.DefaultSlowPeriods)
        => source.ToUltimateOscillator(x => x.HighPrice, x => x.LowPrice, x => x.ClosePrice, fastPeriods, mediumPeriods, slowPeriods);
}