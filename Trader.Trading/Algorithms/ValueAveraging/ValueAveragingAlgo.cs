...
namespace Outcompute.Trader.Trading.Algorithms.ValueAveraging
{
    internal class ValueAveragingAlgo : SymbolAlgo
    {
        ...
        public ValueAveragingAlgo(IOptionsMonitor<ValueAveragingAlgoOptions> monitor, ILogger<ValueAveragingAlgoOptions> logger, ISystemClock clock)
        {
            _monitor = monitor;
            _logger = logger;
            _clock = clock;
        ...
        private IAlgoCommand SetTrackingBuy()
        {
            ...
            return TrackingBuy(Context.Symbol, _options.BuyOrderSafetyRatio, _options.TargetQuoteBalanceFractionPerBuy, _options.MaxNotional, _options.RedeemSavings);
        }
