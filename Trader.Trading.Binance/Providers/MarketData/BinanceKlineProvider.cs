...
namespace Outcompute.Trader.Trading.Binance.Providers.MarketData
{
    internal class BinanceKlineProvider : IKlineProvider
    {
        ...
        public Task<IReadOnlyCollection<Kline>> GetKlinesAsync(string symbol, KlineInterval interval, DateTime start, DateTime end, CancellationToken cancellationToken = default)
        {
