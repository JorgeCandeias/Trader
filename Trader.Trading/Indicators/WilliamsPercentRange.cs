...
public static partial class Indicator
{
    ...
    public static IEnumerable<decimal?> ToWilliamsPercentRange(this IEnumerable<Kline> source, int periods = Indicators.WilliamsPercentRange.DefaultPeriods)
        => source.ToWilliamsPercentRange(x => x.HighPrice, x => x.LowPrice, x => x.ClosePrice, periods);
}