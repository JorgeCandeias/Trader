...
public static partial class Indicator
{
    ...
    public static IEnumerable<decimal?> ToMomentum(this IEnumerable<Kline> source, int periods = Indicators.Momentum.DefaultPeriods)
        => source.ToMomentum(x => x.ClosePrice, periods);
