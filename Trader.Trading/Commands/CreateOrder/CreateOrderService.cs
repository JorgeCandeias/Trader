...
namespace Outcompute.Trader.Trading.Commands.CreateOrder
{
    internal class CreateOrderService : ICreateOrderService
    {
        ...
        public CreateOrderService(ILogger<CreateOrderService> logger, ITradingService trader, IOrderProvider orders)
        {
            _logger = logger;
            _trader = trader;
            _orders = orders;
        ...
        private static string TypeName => nameof(CreateOrderService);
