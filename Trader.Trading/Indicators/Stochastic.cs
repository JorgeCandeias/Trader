...
public static partial class Indicator
{
    ...
    public static IEnumerable<decimal?> ToStochastic(this IEnumerable<Kline> source, int periods = Indicators.Stochastic.DefaultPeriods)
        => source.ToStochastic(x => x.HighPrice, x => x.LowPrice, x => x.ClosePrice, periods);
}