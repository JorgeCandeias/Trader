...
public partial class Indicator
{
    ...
    public static IEnumerable<BollingerBand> ToBollingerBands(this IEnumerable<Kline> source, int periods = Indicators.BollingerBands.DefaultPeriods, int multiplier = Indicators.BollingerBands.DefaultMultipler)
        => ToBollingerBands(source, x => x.ClosePrice, periods, multiplier);
}